...
TEST(SchemaParserTest, parseSuccess01)
{
    ...
    const Schema expected = Init::SchemaInit{}
        ...
        .fields({
            ...
            Init::FieldInit{}.name("field_13").data_type(dtype::String).size(15).metadata("empty"),
            ...
            Init::FieldInit{}.name("field_23").data_type(dtype::String).size(15).nullable(true).metadata("empty"),
